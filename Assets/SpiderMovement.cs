...
public class SpiderMovement : MonoBehaviour {
	...
	bool isOnGround() {
		...
		bool down = Physics2D.Raycast(pos, Vector2.down, yExtent);
		bool diagLeft = Physics2D.Raycast(pos, toLeftCorner, toLeftCorner.magnitude);
		bool diagRight = Physics2D.Raycast(pos, toRightCorner, toRightCorner.magnitude);
        Debug.Log("" + down + diagLeft + diagRight);
	...
	bool objectToRight() {
		...
		bool right = Physics2D.Raycast(pos, Vector2.right, xExtent * 1.2f, pushableMask);
		bool diagUp = Physics2D.Raycast(pos, toTopCorner, toTopCorner.magnitude * 1.2f, pushableMask);
		bool diagDown = Physics2D.Raycast(pos, toBottomCorner, toBottomCorner.magnitude, pushableMask);
        Debug.Log("" + right + diagUp + diagDown);
	...
	bool objectToLeft() {
		...
		bool left = Physics2D.Raycast(pos, Vector2.left, xExtent * 1.2f, pushableMask);
		bool diagUp = Physics2D.Raycast(pos, toTopCorner, toTopCorner.magnitude * 1.2f, pushableMask);
		bool diagDown = Physics2D.Raycast(pos, toBottomCorner, toBottomCorner.magnitude, pushableMask);
        Debug.Log("" + left + diagUp + diagDown);
